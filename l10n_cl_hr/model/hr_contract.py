...
class hr_contract(models.Model):
    ...
    isapre_moneda= fields.Selection([('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda', default="uf")
    ...
    aporte_voluntario_moneda= fields.Selection([('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda', default="uf")
    forma_pago_apv = fields.Selection([('1', 'Directa'), ('2', 'Indirecta')], string='Forma de Pago', default="1")
    seguro_complementario_moneda= fields.Selection([('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda', default="uf")
